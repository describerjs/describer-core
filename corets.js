define(['jquery', 'underscore', '_config'], function ($, _, _config) {
    ...
    dc.helper.doTimeout._func = function (jquery_data_key) {
        ...
        args = arguments, slice_args = 4, id = args[1], delay = args[2], callback = args[3];
        if (typeof id !== 'string') {
            slice_args--;
    ...
    $.plugin = function (name, object) {
        $.fn[name] = function (options) {
            return this.each(function () {
                if (!$.data(this, name)) {
                    //jmname: "sync-val", pluginName: "actions.add", pos: 0
                    //public elem: HTMLElement, public options:Object, public pluginName: string, public pos: string, public jmname:string
